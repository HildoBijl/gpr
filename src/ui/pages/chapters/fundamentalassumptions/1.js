	...
	render() {
		...
		return (
			<div>
				...
				<p>One morning I was feeling scientific, and I started measuring the temperature outside my house. It's winter here, and in Dutch winters the temperature is always near the freezing point. So at 8:00 I measured a temperature of 2 degrees Celsius, while at 10:00 it was exactly 4 °C. Then I wondered: what was the temperature at 9:00?</p>
				<p>You, as a human, can probably guess the answer quite easily. You would say, "Roughly 3 degrees!" Probably everywhere between 2 and 4 degrees would be fine with you, and you might even accept 4.5 °C or so. But if I'd tell you it was 8 °C, you'd say I was nuts.</p>
				...
				<p>Can we also let a computer make such predictions though? Of course the answer is "yes". But if we want to, we must also give the computer this prior knowledge. In short, we have to tell the computer that the temperature only gradually varies over time.</p>
